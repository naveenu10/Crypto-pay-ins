                            ...
                            <div className={classes.QrDiv} >
                                <Container>
                                    ...
                                    {/* <div style={{ marginTop: '35px' }}>
                                        <div style={{ fontSize: '12px', fontWeight: 400 }}>Send to this address</div>
                                        <span>
                                            <input className={classes.addressField} />
                                    ...
                                    <div style={{ marginTop: '35px' }}>
                                        <div style={{ fontSize: '12px', fontWeight: 400, display: 'flex' }}>Send to this address</div>
                                                    ...
                                                    InputProps={{
                                                        ...
                                                        endAdornment: (
                                                            <InputAdornment position="start">
                                                                <Button style={{ padding: '0px', minWidth: '0px', color: '#808080' }} >
                                                                    <img src='https://res.cloudinary.com/dolpotacg/image/upload/v1683014498/Vector_2_aghej8.svg' />
                                                                </Button>
                                                            </InputAdornment>
                                                        ),
                                    ...
                                    <div style={{ marginTop: '5px' }}>
                                        <div style={{ fontSize: '12px', fontWeight: 400, display: 'flex' }}>Amount (excludes network fee)</div>
                                        <Box sx={{ minWidth: 120, display: "flex" }}>
                                            <FormControl sx={{ m: 1, borderRadius: "4px", width: "95%" }}>
                                                <TextField
